import { AwsDynamoDbAdapter } from '@packages/shared/app/src/infraestructure/adapters/aws-dynamo-db.adapter';
import { constantCase } from 'change-case-all';
import dayjs from 'dayjs';
import timezone from 'dayjs/plugin/timezone';
import utc from 'dayjs/plugin/utc';
import { ArcWebsocketEventMessageType } from '../controllers/arc-retail-websocket-events.controller';
