...
import { ChainableSfnDefinition } from '@packages/shared/app/lib/helpers/builders/state-machine.builder';
import { getExecutionStackPath } from '@packages/shared/app/src/application/get-execution-stack-path';
import { LambdaTaskInput } from '@packages/shared/app/src/application/lambda-task-input';
