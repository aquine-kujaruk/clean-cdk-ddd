...
import { getCommonResourceName, getConstructName, getUniqueConstructName } from '../resource-names.util';
import { BaseConstruct } from '../base.construct';

export class EventBusConstruct extends BaseConstruct<EventBusProps> {
  public bus: EventBus;
